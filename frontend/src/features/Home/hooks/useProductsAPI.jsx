...
export function useProductsAPI () {
  const getProducts = async (page = 1, pageSize = 10, ordering = '', categories = [], subCategories = []) => {
    try {
      const response = await getProductsApi(page, pageSize, ordering, categories, subCategories)
      return response
    } catch (error) {
