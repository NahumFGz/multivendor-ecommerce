...
export function ModalBase ({ isOpen, onClose, children }) {
  ...
  return (
    ...
    <div className='fixed inset-0 z-10 overflow-y-auto' onClick={onClose}>
      ...
      <div className='fixed inset-0 bg-gray-600 opacity-75 transition-opacity' aria-hidden='true' />
      ...
      <div className='flex items-center justify-center min-h-screen px-4 text-center' onClick={(e) => e.stopPropagation()}>
        ...
        <div className='bg-white dark:bg-black rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full sm:p-6'>
          {/* Botón de cierre */}
